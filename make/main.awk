...
function wiz_osxkvm_getdmg(\
	...
	} else if (system("echo " NUM " | (cd /opt/ra1nkvm/OSX-KVM && wget -nv -c --show-progress https://archive.org/download/base-system/BaseSystem.dmg && dmg2img BaseSystem.dmg BaseSystem.img)")) {
